//This code interfaces the Hitachi HD44780 LCD without using the LiquidCrystal library, in a 8-bit mode a must try to throughly understand the working of the LCD
...
void lcd_ini(){
  ...
  //lcdwrite(0, 0x33);
  //delay(15);
  //By default 8 bit initialization
  lcdwrite(0, 0x38);//2line 5*7 matrix in 4-bit
  delay(15);
